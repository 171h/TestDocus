...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-f52627a4><div class="alert-content" data-v-f52627a4>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f52627a4"]]);

export { __nuxt_component_2 as default };
//# sourceMappingURL=Alert.6d66466e.mjs.map
