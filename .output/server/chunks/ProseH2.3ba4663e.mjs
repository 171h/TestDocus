...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h2${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-8e1f8b41>`);
...
const ProseH2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e1f8b41"]]);

export { ProseH2 as default };
//# sourceMappingURL=ProseH2.3ba4663e.mjs.map
