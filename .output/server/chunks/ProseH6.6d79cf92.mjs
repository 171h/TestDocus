...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h6${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-4b1928c2>`);
...
const ProseH6 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4b1928c2"]]);

export { ProseH6 as default };
//# sourceMappingURL=ProseH6.6d79cf92.mjs.map
