...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h5${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-dea06e3e>`);
...
const ProseH5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dea06e3e"]]);

export { ProseH5 as default };
//# sourceMappingURL=ProseH5.6a392a30.mjs.map
