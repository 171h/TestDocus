...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-b1cbd90f>`);
      if (__props.filename) {
        _push(`<span class="filename" data-v-b1cbd90f>${ssrInterpolate(__props.filename)}</span>`);
      } else {
        _push(`<!---->`);
      }
...
const ProseCode = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b1cbd90f"]]);
...
//# sourceMappingURL=ProseCode.355dde17.mjs.map
