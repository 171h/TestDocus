...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-7f704b0b>`);
...
const ProseH1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7f704b0b"]]);

export { ProseH1 as default };
//# sourceMappingURL=ProseH1.3518aaaf.mjs.map
