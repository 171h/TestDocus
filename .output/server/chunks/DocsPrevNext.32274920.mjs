  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(prev) || unref(next)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "docs-prev-next" }, _attrs))} data-v-52bebc51>`);
        if (unref(prev)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="directory" data-v-52bebc51${_scopeId}>${ssrInterpolate(directory(unref(prev)._path))}</span><span class="title-wrapper" data-v-52bebc51${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "heroicons-outline:arrow-sm-left",
                  class: "icon"
                }, null, _parent2, _scopeId));
                _push2(`<span class="title" data-v-52bebc51${_scopeId}>${ssrInterpolate(unref(prev).title)}</span></span>`);
              } else {
                return [
          ...
          _push(`<span data-v-52bebc51></span>`);
        }
        if (unref(next)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: unref(next)._path,
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="directory" data-v-52bebc51${_scopeId}>${ssrInterpolate(directory(unref(next)._path))}</span><span class="title-wrapper" data-v-52bebc51${_scopeId}><span class="title" data-v-52bebc51${_scopeId}>${ssrInterpolate(unref(next).title)}</span>`);
                _push2(ssrRenderComponent(_component_Icon, {
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52bebc51"]]);

export { __nuxt_component_5 as default };
//# sourceMappingURL=DocsPrevNext.32274920.mjs.map
