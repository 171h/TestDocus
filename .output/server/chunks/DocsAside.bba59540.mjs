...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(_attrs)} data-v-14024474>`);
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="text" data-v-14024474${_scopeId}>Go back</span>`);
            } else {
              return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14024474"]]);

export { __nuxt_component_1 as default };
//# sourceMappingURL=DocsAside.bba59540.mjs.map
