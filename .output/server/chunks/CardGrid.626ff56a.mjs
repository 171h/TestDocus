...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "card-grid" }, _attrs))} data-v-095ac54b>`);
      _push(ssrRenderComponent(_component_ContentSlot, {
        use: _ctx.$slots.root
      }, null, _parent));
      _push(`<h2 class="title" data-v-095ac54b>`);
      _push(ssrRenderComponent(_component_ContentSlot, {
        use: _ctx.$slots.title,
        unwrap: "p"
      }, null, _parent));
      _push(`</h2><div class="layout" data-v-095ac54b>`);
...
const CardGrid = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-095ac54b"]]);

export { CardGrid as default };
//# sourceMappingURL=CardGrid.626ff56a.mjs.map
