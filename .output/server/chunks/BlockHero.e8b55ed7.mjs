...
import __nuxt_component_1 from './ButtonLink.bec9878a.mjs';
import __nuxt_component_2 from './Terminal.100beac5.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "block-hero" }, _attrs))} data-v-b828c477><div class="layout" data-v-b828c477><div class="content" data-v-b828c477>`);
      if (_ctx.$slots.announce) {
        _push(`<p class="announce" data-v-b828c477>`);
      ...
      if (_ctx.$slots.title) {
        _push(`<h1 class="title" data-v-b828c477>`);
        _push(ssrRenderComponent(_component_ContentSlot, {
      ...
      if (_ctx.$slots.description) {
        _push(`<p class="description" data-v-b828c477>`);
        _push(ssrRenderComponent(_component_ContentSlot, {
      ...
      if (_ctx.$slots.extra) {
        _push(`<div class="extra" data-v-b828c477>`);
        _push(ssrRenderComponent(_component_ContentSlot, {
      ...
      _push(`<div class="actions" data-v-b828c477>`);
      if (!_ctx.$slots.actions) {
        ...
        if (__props.secondary) {
          _push(`<a${ssrRenderAttr("href", __props.secondary[1])} class="secondary" data-v-b828c477>${ssrInterpolate(__props.secondary[0])}</a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      ...
      _push(`</div></div><div class="support" data-v-b828c477>`);
...
const BlockHero = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b828c477"]]);

export { BlockHero as default };
//# sourceMappingURL=BlockHero.e8b55ed7.mjs.map
