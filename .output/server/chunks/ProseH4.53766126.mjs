...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h4${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-5c301252>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5c301252"]]);

export { __nuxt_component_0 as default };
//# sourceMappingURL=ProseH4.53766126.mjs.map
