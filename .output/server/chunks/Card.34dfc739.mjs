...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div data-v-a65b3536><h3 class="title" data-v-a65b3536>`);
      ...
      _push(`</h3><p class="description" data-v-a65b3536>`);
      _push(ssrRenderComponent(_component_ContentSlot, {
...
const Card = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a65b3536"]]);

export { Card as default };
//# sourceMappingURL=Card.34dfc739.mjs.map
