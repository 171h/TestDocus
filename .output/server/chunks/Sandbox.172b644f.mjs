...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sandbox" }, _attrs))} data-v-6605ea80>`);
      if (!__props.src) {
      ...
      if (unref(url)) {
        _push(`<iframe${ssrRenderAttr("src", unref(url))} title="Sandbox editor" sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin" data-v-6605ea80></iframe>`);
      } else {
        _push(`<span data-v-6605ea80>Loading Sandbox...</span>`);
      }
      _push(`</div>`);
    };
  }
...
const Sandbox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6605ea80"]]);

export { Sandbox as default };
//# sourceMappingURL=Sandbox.172b644f.mjs.map
