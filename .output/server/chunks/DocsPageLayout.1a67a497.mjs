import { _ as _export_sfc, f as useContent, h as useRoute, g as useDocus, l as useState, m as __nuxt_component_0$4, d as __nuxt_component_0$3 } from './server.mjs';
import __nuxt_component_1 from './DocsAside.bba59540.mjs';
import __nuxt_component_2 from './Alert.6d66466e.mjs';
import __nuxt_component_1$1 from './ProseCodeInline.c5c395f1.mjs';
import __nuxt_component_5 from './DocsPrevNext.32274920.mjs';
import __nuxt_component_7 from './DocsToc.ac4f38bc.mjs';
...
import './DocsTocLinks.68a3ca32.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Container, mergeProps({
        fluid: (_b = (_a = unref(docus)) == null ? void 0 : _a.layout) == null ? void 0 : _b.fluid,
        padded: "",
        class: ["docs-page-content", [((_d = (_c = unref(docus)) == null ? void 0 : _c.layout) == null ? void 0 : _d.fluid) && "fluid"]]
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(hasAside)) {
              _push2(`<aside class="aside-nav" data-v-5d3154e7${_scopeId}>`);
            ...
            }, "page-body"])}" data-v-5d3154e7${_scopeId}>`);
            if (unref(hasBody)) {
            ...
            _push2(`</article>`);
            if (unref(hasToc)) {
              _push2(`<div class="toc" data-v-5d3154e7${_scopeId}><div class="toc-wrapper" data-v-5d3154e7${_scopeId}><button data-v-5d3154e7${_scopeId}><span class="title" data-v-5d3154e7${_scopeId}>Table of Contents</span>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "heroicons-outline:chevron-right",
                class: ["icon", [unref(isOpen) && "rotate"]]
              }, null, _parent2, _scopeId));
              _push2(`</button><div class="${ssrRenderClass([[unref(isOpen) && "opened"], "docs-toc-wrapper"])}" data-v-5d3154e7${_scopeId}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5d3154e7"]]);

export { __nuxt_component_0 as default };
//# sourceMappingURL=DocsPageLayout.1a67a497.mjs.map
