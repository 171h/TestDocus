...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-layout" }, _attrs))} data-v-14464996>`);
      _push(ssrRenderComponent(_component_Container, {
        fluid: (_a = unref(page2)) == null ? void 0 : _a.fluid,
        padded: (_b = unref(page2)) == null ? void 0 : _b.padded
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<article data-v-14464996${_scopeId}>`);
...
const page = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14464996"]]);

export { page as default };
//# sourceMappingURL=page.4af7ad5d.mjs.map
