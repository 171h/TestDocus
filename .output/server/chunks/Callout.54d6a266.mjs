...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-9abedd74><span class="preview" data-v-9abedd74><span class="summary" data-v-9abedd74>`);
      ...
      _push(`</span><div style="${ssrRenderStyle(unref(isOpen) ? null : { display: "none" })}" class="content" data-v-9abedd74>`);
      _push(ssrRenderComponent(_component_ContentSlot, {
...
const Callout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9abedd74"]]);

export { Callout as default };
//# sourceMappingURL=Callout.54d6a266.mjs.map
